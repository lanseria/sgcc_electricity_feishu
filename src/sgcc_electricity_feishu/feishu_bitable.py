...
class FeishuBitableHelper:
    ...
    def list_records(self, view_id=None, field_names=None, sort=None, page_size=20):
        ...
        if view_id:
            request_body_builder = request_body_builder.view_id(view_id)
    ...
    def list_table_fields(self, view_id=None, page_size=20):
